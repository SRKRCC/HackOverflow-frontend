...
const Schedule: React.FC = () => {
  ...
  const stages: Stage[] = [
    ...
    },
    {
      ...
      icon: Laptop,
      details: "The main event! An intensive 24-hour hackathon where registered teams build their minimum viable product. Work collaboratively in a high-energy environment with food, networking, and technical support.",
      date: "December 19-20, 2025",
      duration: "24 hours non-stop",
      participants: "Registered teams only",
