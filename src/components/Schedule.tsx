  ...
  const stages: Stage[] = [
    {
      ...
      objective: "Form teams and submit initial project concepts",
    ...
    },
    {
      ...
      title: "Project Pitch", 
      icon: Presentation,
      details: "Create and deliver a compelling presentation about your project idea. Showcase your technical approach, market research, and implementation strategy. This is your chance to demonstrate the feasibility and impact of your solution to industry experts.",
      date: "September 15, 2024",
      duration: "1 day",
      participants: "All registered teams",
      objective: "Present your vision and technical approach",
      ...
      position: { x: 300, y: 50 },
      mobilePosition: { x: 220, y: 160 }
    },
    {
      key: "shortlisting",
      title: "Team Selection",
      icon: ClipboardList, 
      details: "Expert judges will carefully review all submissions based on innovation, technical feasibility, market potential, and team composition. Selected teams will receive mentorship opportunities and access to exclusive resources for the main event.",
      date: "September 20, 2024",
      duration: "Evaluation day",
      participants: "Judging panel",
      objective: "Select top teams for the hackathon",
    ...
    },
    {
      ...
      icon: Laptop,
      details: "The main event! An intensive 48-hour coding marathon where selected teams build their minimum viable product. Access mentors, APIs, cloud credits, and premium development tools. Work collaboratively in a high-energy environment with food, networking, and technical support.",
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                ...
                >
                  ...
                  <div className="flex items-center space-x-2 md:space-x-3 mb-2 md:mb-3 relative z-10">
                    ...
                    <span className="text-xs md:text-sm font-semibold tracking-wide text-muted-foreground">DATE</span>
                  </div>
