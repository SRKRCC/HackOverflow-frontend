    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-orange-50 px-6 py-12">
      ...
      <div className="max-w-3xl mx-auto mb-6">
        <input
          ...
          className="w-full px-4 py-2 border border-orange-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
        />
      </div>

      {/* Teams Table */}
      <div className="overflow-x-auto max-w-5xl mx-auto rounded-lg">
        <table className="bg-white shadow-lg border border-orange-200 w-full">
          ...
          <tbody>
            {paginatedTeams.length > 0 ? (
              paginatedTeams.map((team) => (
                ...
                >
                  <td className="px-4 py-3">{team.teamId}</td>
