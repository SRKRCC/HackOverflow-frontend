...
const HeroSection = () => {
  ...
  return (
    <div
      id="home"
      className=" flex flex-col md:flex-row items-center justify-center md:justify-between px-6 md:px-24 gap-0 md:gap-16 relative overflow-hidden py-10 md:py-0"
    >
      ...
      <div className="flex-1 z-10">
        <div className="animate-slide-up">
          <h1 className="text-5xl md:text-8xl leading-tight sm:mb-6 mb-3">
        ...
        <div className="animate-slide-up" style={{ animationDelay: "0.2s" }}>
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl leading-relaxed">
            Join the ultimate hackathon experience — innovate, collaborate, and
            excel! Connect with brilliant minds, build groundbreaking solutions,
        ...
        <div
          className="animate-slide-up flex flex-col md:flex-row gap-4 mb-4"
      ...
      {/* Right Content - Image */}
      <div
        className="flex-1 z-10 animate-scale-in hidden md:flex"
        style={{ animationDelay: "1s" }}
      >
